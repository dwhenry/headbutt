  ...
  module Middleware
    module Server
      ...
      class RetryJobs
        ...
        def schedule_retry(worker, job, exception)
          ...
          if count < max_retry_attempts
            ...
            Headbutt::BunnyManager.instance.task_retry_queue.publish(
              job.merge(payload),
              expiration: expiration,
            )
          else
            # record the death of a salesperson.. :(
          end
        end
